...
JAILHOUSE_OUTPUT_FILE=$(grep_token_in_file "JAILHOUSE_OUTPUT_FILE: " $data_output_dir/experiment_*.txt)
LINUX_OUTPUT_FILE=$(grep_token_in_file "LINUX_OUTPUT_FILE: " $data_output_dir/experiment_*.txt)
...
VTUNE_OUTPUT_FILE=$(grep_token_in_file "VTUNE_OUTPUT_FILE: " $data_output_dir/experiment_*.txt)
